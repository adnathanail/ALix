      ...
      modules = [
        ...
        ({ pkgs, ... }: {
          ...
          homebrew = {
            ...
            casks = [ "1password" "1password-cli" "orbstack" "raycast" "bartender" "ghostty" "microsoft-outlook" "slack" "todoist-app" "fantastical" "spotify" "whatsapp" "google-drive" "steam" "discord" ];
          };
        })
